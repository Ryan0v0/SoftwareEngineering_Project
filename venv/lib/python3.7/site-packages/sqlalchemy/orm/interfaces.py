...
class MapperProperty(_MappedAttribute, InspectionAttr, util.MemoizedSlots):
    ...
    def class_attribute(self):
        ...
        and the class to which it is mapped is ``Device``, this sequence
        is possible::

            >>> from sqlalchemy import inspect
            >>> mapper = inspect(Device)
            >>> addresses_property = mapper.attrs.addresses
            >>> addresses_property.class_attribute is Device.addresses
            True
            >>> Device.addresses.property is addresses_property
            True
...
class PropComparator(operators.ColumnOperators):
    ...
    Device-defined subclasses of :class:`.PropComparator` may be created. The
