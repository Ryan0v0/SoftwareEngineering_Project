...
class AliasedClass(object):
    ...
    Usage example::
        ...
        session.query(Device, user_alias).\
                        join((user_alias, Device.id > user_alias.id)).\
                        filter(Device.name==user_alias.name)
...
def join(
    ...
    :meth:`.Query.select_from` method, as in::
        ...
        session.query(Device).\
            select_from(join(Device, Address, Device.addresses)).\
